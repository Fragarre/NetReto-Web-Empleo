                ...
                for id_emp, url in detalles:
                    ...
                    if existente:
                        ...
                        for indice, campo in enumerate(campos, start=1):
                            anterior, nuevo = existente[indice], valores[indice - 1]
                            if anterior != nuevo:
                    ...
                    if cursor.fetchone() is None:
                        cursor.execute("""INSERT INTO publicaciones (proceso_id, fuente_id, referencia, tipo, titulo, fecha_publicacion, url, contenido_hash, contenido_texto, datos_json) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)""", (proceso_id, GVA_FUENTE_ID, publicacion["referencia"], publicacion["tipo"], publicacion["titulo"], publicacion["fecha_publicacion"], publicacion["url"], publicacion["contenido_hash"], publicacion["contenido_texto"], Jsonb(publicacion["datos_json"])))
